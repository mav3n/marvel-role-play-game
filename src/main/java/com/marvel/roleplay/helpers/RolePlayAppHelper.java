...
public class RolePlayAppHelper {
  ...
  public static List<MarvelCharacter> getMarvelCharactersList() {
    return marvelCharacters.values()
        .stream()
        .sorted(Comparator.comparing(MarvelCharacter::getId))
        .collect(Collectors.toList());
  }

  public static List<MarvelCharacter> getEvilMarvelCharactersList() {
    return evilMarvelCharacters.values()
        .stream()
        .sorted(Comparator.comparing(MarvelCharacter::getId))
        .collect(Collectors.toList());
  }
  ...
  public static Player getRandomEvilPlayer(Integer energyLevel) {
    Integer randomId =
        new ArrayList<>(evilMarvelCharacters.keySet()).get(new Random().nextInt(evilMarvelCharacters.size()));
  ...
  public static Map<FightAction, Integer> createEnergyMap(int frontKick, int flyingKick, int punch, int superPunch, int flip) {
    ...
    energyMap.put(FightAction.BLOCK, 0);
    return energyMap;
  }
  ...
  private static void loadDefaultCharacters() {
    ...
    marvelCharacters.put(7,
        new MarvelCharacter(7, "Captain America", Power.STRENGTH, createEnergyMap(7, 12, 7, 12, 7), 28));
    marvelCharacters.put(8,
        new MarvelCharacter(8, "Black Panther", Power.SPEED, createEnergyMap(8, 12, 6, 10, 10), 15));
    marvelCharacters.put(9, new MarvelCharacter(9, "Wasp", Power.SHRINK, createEnergyMap(4, 7, 4, 7, 7), 8));
    marvelCharacters.put(10,
        new MarvelCharacter(10, "Spider Man", Power.DURABILITY, createEnergyMap(4, 6, 4, 8, 6), 5));
    // Evil characters
    evilMarvelCharacters.put(101,
        new MarvelCharacter(101, "Thanos", Power.STRENGTH, createEnergyMap(5, 10, 12, 20, 10), 89));
    evilMarvelCharacters.put(102, new MarvelCharacter(102, "Loki", Power.MIND, createEnergyMap(4, 6, 4, 7, 5), 39));
    evilMarvelCharacters.put(103,
        new MarvelCharacter(103, "Ultron", Power.STAMINA, createEnergyMap(6, 12, 10, 15, 8), 49));
    evilMarvelCharacters.put(104,
        new MarvelCharacter(104, "Red Skull", Power.DURABILITY, createEnergyMap(5, 8, 6, 10, 6), 59));
    evilMarvelCharacters.put(105,
        new MarvelCharacter(105, "Mandarin", Power.SPEED, createEnergyMap(5, 10, 7, 12, 5), 69));
  }
  // endregion
}
